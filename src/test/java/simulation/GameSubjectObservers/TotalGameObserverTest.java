...
public class TotalGameObserverTest {
    ...
    @Test
    public void update() {
        IGameObserver totalGameObserver = new TotalGameObserver();
        totalGameObserver.update(hockeyContext.getUser().getLeague(), "Team11", 3);
