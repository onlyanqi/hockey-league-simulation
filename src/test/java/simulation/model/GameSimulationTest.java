...
public class GameSimulationTest {
    ...
    public void parameterConstructorTest() {
        IGameSimulation gameSimulation = hockeyContext.getModelFactory().createGameSimulationFromTeams(team11, team12);
    ...
    public void testSetTeam1Shift() {
        IGameSimulation gameSimulation = hockeyContext.getModelFactory().createGameSimulationFromTeams(team11, team12);
        gameSimulation.setTeam1Shift(hockeyContext.getModelFactory().createShift());
        assertNotNull(gameSimulation.getTeam1Shift());
    }
    ...
    public void testSetTeam2Shift() {
        IGameSimulation gameSimulation = hockeyContext.getModelFactory().createGameSimulationFromTeams(team11, team12);
        gameSimulation.setTeam2Shift(hockeyContext.getModelFactory().createShift());
        assertNotNull(gameSimulation.getTeam2Shift());
    }
