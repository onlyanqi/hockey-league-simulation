...
public class ImportState implements IHockeyState {
    ...
    private GamePlayConfig loadGamePlayConfigJSON(JSONObject gameplayConfigJSONObject) {
    ...
    private List<Team> loadTeamJSON(JSONArray teams) {
        ...
        for (Object teamObjectFromJSONArray : teams) {
            ...
            Coach coach = setCoachVariables(coachName, skating, shooting, checking, saving);
